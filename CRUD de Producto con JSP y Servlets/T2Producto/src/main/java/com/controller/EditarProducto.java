 ...
 * Esta clase representa un servlet para editar un producto existente.
 */
public class EditarProducto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Manejar excepciones adecuadamente, por ejemplo, enviar a una página de error específica
        }
